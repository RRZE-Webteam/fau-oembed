...
class FAU_oEmbed {
    ...
    private static function fetch($provider, $url, $args = '') {
        ...
        $result = self::fetch_with_format($provider);
    ...
    private static function fetch_with_format($provider_url_with_args) {
    ...
    private static function parse_json($response_body) {
